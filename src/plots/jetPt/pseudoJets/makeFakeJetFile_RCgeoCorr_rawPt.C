// Build rootFiles/fakeJets/fakeJets_RCgeoCorr_rawPt.root -- raw-pT axis,
// geometrically-corrected random-cone background subtraction. Combines the two
// variations makeFakeJetFile.C has separate single-axis siblings for:
//   makeFakeJetFile_rawPt.C      : raw axis,      plain RC background subtraction
//   makeFakeJetFile_RCgeoCorr.C  : JEC-corrected,  RC_geoCorr background subtraction
// this file                      : raw axis,      RC_geoCorr background subtraction
//
// Fake-jet estimate = FastJet, raw (non-JEC) pT, geometrically-corrected
// random-cone per-jet background subtraction:
//   FastJet  : h_fastJetPt_PF_bkgSub_RC_geoCorr_C{i} / N_events   (one clustering per event)
...
const char *fjHistBase = "h_fastJetPt_PF_bkgSub_RC_geoCorr";
...
void makeFakeJetFile_RCgeoCorr_rawPt(){
